...
function wpsm_dazz_cs_review() {
	...
	<div class="notice notice-info is-dismissible wpsm-dazz-cs-review-notice">
		<div style="float:left;margin-right:10px;margin-bottom:5px;">
			<img style="width:100%;width: 120px;height: auto;" src="<?php echo DAZZ_CSW_PLUGIN_URL.'assets/images/icon-show.png'; ?>" />
		</div>
		
		
		<p style="font-size:18px;">'A big sale Get  <strong>40% off </strong> on our every Wordpress Plugins (including Coming Soon Plugin) hurry up offer expire date is <strong>31st December </strong> USE THIS COUPON CODE  -  <strong style="color:#ef4238">OFF40</strong></p>
		<p style="font-size:18px;"><strong><?php _e( '~ dazzlersoft', '' ); ?></strong></p>
		<p style="font-size:19px;"> 
			<a style="color: #fff;background: #ed1c94;padding: 4px 10px 8px 10px;border-radius: 4px;text-decoration: none;" href="https://wpshopmart.com/plugins/" class="wpsm-dazz-cs-dismiss-review-notice wpsm-dazz-cs-review-out" target="_blank" rel="noopener">Grab This Offer Now </a>&nbsp; &nbsp;
			<a style="color: #fff;background: #27d63c;padding: 4px 10px 8px 10px;border-radius: 4px;text-decoration: none;" href="#"  class="wpsm-dazz-cs-dismiss-review-notice wpsm-rate-later" target="_self" rel="noopener"><?php _e( 'No, I am not interested', '' ); ?></a>&nbsp; &nbsp;
			<a style="color: #fff;background: #31a3dd;padding: 4px 10px 8px 10px;border-radius: 4px;text-decoration: none;" href="#" class="wpsm-dazz-cs-dismiss-review-notice wpsm-rated" target="_self" rel="noopener"><?php _e( 'I already Purchased', '' ); ?></a>
		</p>
